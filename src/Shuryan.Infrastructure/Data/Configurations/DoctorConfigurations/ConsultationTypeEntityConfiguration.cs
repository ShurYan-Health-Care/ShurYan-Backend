...
namespace Shuryan.Infrastructure.Data.Configurations.DoctorConfigurations
{
    public class ConsultationTypeEntityConfiguration : IEntityTypeConfiguration<ConsultationType>
    {
        public void Configure(EntityTypeBuilder<ConsultationType> builder)
        {
            ...
            // Seeding Data
            builder.HasData(
                new ConsultationType { Id = Guid.Parse("11111111-1111-1111-1111-111111111111"), ConsultationTypeEnum = ConsultationTypeEnum.Regular },
                new ConsultationType { Id = Guid.Parse("22222222-2222-2222-2222-222222222222"), ConsultationTypeEnum = ConsultationTypeEnum.FollowUp }
            );
        }
    }
}
