...
namespace Shuryan.Infrastructure.Migrations
{
    ...
    [Migration("20260502000937_UpdateDoctorAppointmentDuration")]
    partial class UpdateDoctorAppointmentDuration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shuryan.Core.Entities.Medical.Consultations.DoctorConsultation", b =>
                {
                    ...
                    b.ToTable("DoctorConsultations", null, t =>
                        {
                            t.HasCheckConstraint("CK_DoctorConsultation_Duration", "[SessionDurationMinutes] >= 5 AND [SessionDurationMinutes] <= 480");
